...
int main(int argc, char** argv) {
	...
	editor_insert_text_before_cursor(&editor, "sahduisahifhsa");
	editor_insert_new_line(&editor);
	editor_insert_text_before_cursor(&editor, "0asfji33hisnj");
	editor_insert_new_line(&editor);
	editor_insert_text_before_cursor(&editor, "aksnfjkdiuhas");
	editor_insert_new_line(&editor);
	editor_insert_text_before_cursor(&editor, "39eu9whaiojdf");
	editor_insert_new_line(&editor);
	editor_insert_text_before_cursor(&editor, "ifisdhg8e");
